    ...
    <footer className="relative py-16 px-4" role="contentinfo">
      <div className="max-w-4xl mx-auto">
        <div className="text-center">
          <div
            className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-white/60 backdrop-blur-md border border-white/50 shadow-glass mb-6"
            aria-hidden="true"
          >
          ...
          {/* Navigation Links */}
          <nav className="flex flex-wrap justify-center gap-4 mb-6" aria-label="Footer navigation">
            {navLinks.map((link) => (
              <Link
                key={link.to}
                to={link.to}
          ...
          <div className="flex justify-center gap-6 mb-6">
            <a
              ...
              className="text-sm text-foreground/50 hover:text-[#5865F2] transition-colors flex items-center gap-1"
            >
