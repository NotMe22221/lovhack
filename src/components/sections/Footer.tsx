...
const Footer = () => {
  ...
  return <footer className="relative py-16 px-4" role="contentinfo">
      <div className="max-w-4xl mx-auto">
        <div className="text-center">
          ...
          <nav className="mt-6 flex justify-center gap-6" aria-label="Footer navigation">
            <a href="https://t.co/tciohUF17q" target="_blank" rel="noopener noreferrer" className="text-sm text-foreground/50 hover:text-primary transition-colors">
              Register
            </a>
            <a href="https://t.co/qMNpoZoiQZ" target="_blank" rel="noopener noreferrer" className="text-sm text-foreground/50 hover:text-primary transition-colors">
              Discord
            </a>
