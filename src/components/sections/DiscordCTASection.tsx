    ...
    <section className="relative py-16 sm:py-20 md:py-24 px-4">
      <div className="max-w-4xl mx-auto">
        <GlassCard className="p-5 sm:p-8 md:p-12 text-center bg-gradient-to-br from-[#5865F2]/10 via-transparent to-primary/10">
          {/* Discord Icon */}
          <div className="inline-flex items-center justify-center w-14 h-14 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-[#5865F2] mb-6 sm:mb-8 shadow-xl">
          ...
          {/* Benefits Grid */}
          <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4 mb-8 sm:mb-10">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex flex-col items-center gap-1.5 sm:gap-2 p-3 sm:p-4">
          ...
          <Button
            asChild
            size="lg"
            className="w-full sm:w-auto bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-2xl px-8 sm:px-10 py-5 sm:py-6 text-base sm:text-lg shadow-xl hover:shadow-2xl transition-all duration-300 active:scale-95 sm:hover:scale-105"
          >
            <a
              href="https://t.co/qMNpoZoiQZ"
              target="_blank"
