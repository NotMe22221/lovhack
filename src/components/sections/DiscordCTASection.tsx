...
const DiscordCTASection = ({ variant = "default" }: DiscordCTASectionProps) => {
    ...
    return (
      <section className="relative py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <GlassCard className="p-8 text-center bg-gradient-to-r from-[#5865F2]/10 to-primary/10">
  ...
  return (
    <section className="relative py-24 px-4">
      <div className="max-w-4xl mx-auto">
        <GlassCard className="p-8 md:p-12 text-center bg-gradient-to-br from-[#5865F2]/10 via-transparent to-primary/10">
          {/* Discord Icon */}
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-[#5865F2] mb-8 shadow-xl">
          ...
          <Button
            asChild
            size="lg"
            className="bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-2xl px-10 py-6 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
          >
            <a
              href="https://t.co/qMNpoZoiQZ"
              target="_blank"
