...
const DiscordCTASection = ({ variant = "default" }: DiscordCTASectionProps) => {
      ...
      <section ref={sectionRef} className="relative py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div ref={contentRef} className="opacity-0">
            <GlassCard className="p-5 sm:p-6 md:p-8 text-center bg-gradient-to-r from-primary/10 to-primary/5 backdrop-blur-2xl">
              <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2 sm:mb-3">
                Ready to Join?
              </h3>
              <p className="text-sm sm:text-base text-foreground/70 mb-4 sm:mb-6">
                Get early access, find teammates, and connect with builders.
              </p>
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl sm:rounded-2xl px-6 sm:px-8 py-4 sm:py-5 shadow-xl shadow-primary/20 transition-all duration-300 hover:scale-105"
              >
                <a
  ...
  return (
    <section ref={sectionRef} className="relative py-14 sm:py-18 md:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div ref={contentRef} className="opacity-0">
          <GlassCard className="p-6 sm:p-8 md:p-10 text-center bg-gradient-to-br from-primary/10 via-transparent to-primary/5 backdrop-blur-2xl">
            {/* Discord Icon - Smaller */}
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl bg-[#5865F2] mb-5 sm:mb-6 shadow-xl shadow-[#5865F2]/30 transition-transform duration-300 hover:scale-110">
            ...
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl sm:rounded-2xl px-8 sm:px-10 py-5 sm:py-6 text-base sm:text-lg shadow-xl shadow-primary/25 transition-all duration-300 hover:scale-105"
            >
              <a
                href="https://t.co/qMNpoZoiQZ"
                target="_blank"
