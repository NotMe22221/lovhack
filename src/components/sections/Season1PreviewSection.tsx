import { ArrowRight, Trophy, Users, Globe, Rocket } from "lucide-react";
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="bg-white/40 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30"
                >
